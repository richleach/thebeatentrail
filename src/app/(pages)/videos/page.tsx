...
async function getData() {
  const res = await fetch(
    `https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=36&playlistId=UUnIyytMWGt41WZAc6QocKcQ&key=AIzaSyDFdaGd23nu4RpHJekcUk3cnjmpao11Hjk`,
  )
